...
/* =========================================================================
   ...
   ========================================================================= */
const A4_CONTENT_WIDTH_PX = 718; // 190mm - حشو وإطار، عند 96dpi
...
function measureRowHeights(
  ...
  theadHtml: string,
  leadingRowsHtml?: string,
): { rows: number[]; leading: number; thead: number } | null {
  ...
  host.innerHTML = `
    ...
    <table class="m-tbl">${colgroupHtml}${theadHtml}<tbody>${leadingRowsHtml ?? ""}${rowsHtml.join("")}</tbody></table>
  `;
